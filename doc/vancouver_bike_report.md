...
reports every month. The Vancouver Police Department has collected
...
2003. We looked at this data and analyzed it in an attempt to uncover
...
<img src="../results/figures/viz_exploratory.png" width="2000px" />
...
As we can see from the summary table above, the p-value is
infinitesmally small. Thus the null hypothesis is rejected and we can
say with confidence that there is a higher incidence of bike thefts in
the summer time. Figure 2 below highlights the differences between the
two groups.

<img src="../results/figures/bike_boxplot.png" width="2000px" />
